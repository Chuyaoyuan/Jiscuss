...
<div class="header">欢迎来到这里，${data},主题数： ${allDiscussions?size} ，主题页数：${pageDiscussions?size}，标签数 ${allTags?size} </div>
<ul class="list">
...
<div class="ui secondary menu">
    <a class="item active" data-tab="fourth"> <i class="icon mail"></i>
        最新回复
        <div class="floating ui red label">22</div></a> <a class="item "
...
<div class="ui active tab segment" data-tab="fourth">
	...
	<div class="event">
        ...
        <div class="content">
          ...
          <div class="extra text" style="width: 300px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">
     		  ${discussions.content}
          </div>
          <div class="meta">
            <div class=" description "><i class="edit icon"></i> <a><b>用户1</b></a>&nbsp;&nbsp;•&nbsp;&nbsp; <i class="reply icon"></i>最后由 <a><b>${discussions.last_user_id}</b></a> 回复于10 hours ago.</div>
          </div>
